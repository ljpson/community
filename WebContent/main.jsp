			...
			<table border=0 width=100%>
				...
				<tr bgcolor="lavender">
					<td colspan=2 height=27px style="font-size: 14px;">
						<a href="./BoardDetail.do?num=${pbl.num}&page=1&bl_code=${pbl.bl_code}" >
				...
				<tr>
					...
					<td width=80px>
						<a href="./BoardDetail.do?num=${pbl.num}&page=1&bl_code=${pbl.bl_code}" style="text-decoration:none">
						<img src="./boardupload/${pbl.board_file}" width="80" height="80"></a>
					</td>
				</tr>
				<tr bgcolor="#ccdfeb">
